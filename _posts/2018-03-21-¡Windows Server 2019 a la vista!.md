...
Ayer día 20 de marzo de 2018, el equipo de Windows Server lanzaba la noticia de que Windows Server 2019 estaría disponible en la segunda mitad del año 2018. Sin embargo, ya desde este preciso momento se puede acceder a la preview build a través del [programa Insider](https://insider.windows.com/en-us/for-business-getting-started-server/).
...
Después de analizar lo que los clientes de Windows Server pedían, el estudio de la telemetría y hacia donde se desarrolla la industria, en este Windows Server 2019 se han mejorado cuatro temas fundamentalmente: las infraestructuras híbridas, la seguridad, las plataformas de aplicaciones y las infraestructuras hiperconvergentes (HCI).

### Escenarios de nubes híbridas

En estos últimos años la nube está teniendo un gran crecimiento y las empresas cada día se apoyan más en soluciones cloud para mejorar su negocio. Por ello, sus modelos productivos se adaptan a estos nuevos servicios. Para la mayoría de las empresas, un enfoque híbrido que combine los entornos locales y la nube, parece ser la mejor opción. La extensión de Active Directory en Azure, la sincronización de archivos y las copias de seguridad en la nube son algunos de los ejemplos que se pueden encontrar en las empresas a la hora de aprovechar los servicios cloud.
...
Actualmente, la infraestructura hiperconvergente es una de las últimas tendencias en la industria de servidores en la actualidad. Según IDC, el [mercado de HCI creció un 64%](https://thestack.com/data-centre/2017/06/26/hyperconverged-market-grows-64-over-2016/) en 2016.
...
A Microsoft le queda aún mucho que compartir con nosotros sobre Windows Server 2019 durante los próximos meses y hasta la fecha de lanzamiento. Nos irán dando más detalles sobre las áreas tratadas en este post.

Asimismo, nos recuerdan que si no podemos esperar más para probar la nueva versión de Windows Server podemos hacerlo ya desde [la plataforma Insider](https://insider.windows.com/en-us/for-business-getting-started-server/).

Espero que el post os haya gustado y la información os haya resultado útil. Comentad que os parecen las novedades que veremos en Windows Server 2019 y nos vemos en el próximo post.
